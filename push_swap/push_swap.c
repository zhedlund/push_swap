...
/*   Updated: 2023/09/14 13:33:09 by zhedlund         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	while ((*stack_a != lowest_cost_node->target_node)
		&& (*stack_b != lowest_cost_node))
		rr(stack_a, stack_b);
...
static void	rotate_to_target(t_stack **stack, t_stack *lowest_cost_node,
	char stack_name)
{
...
static void	rotate_and_push(t_stack **stack_a, t_stack **stack_b)
{
	...
	else if (!(lowest_cost_node->top_half)
		&& !(lowest_cost_node->target_node->top_half))
